...
- Call Adzuna API:
  - GET [https://api.adzuna.com/v1/api/jobs/{country}/search/1](https://api.adzuna.com/v1/api/jobs/{country}/search/1)
...
- Derive company homepage URL by following the Adzuna redirect with server-side fetch() — no browser needed for this step:
  ...
  - If response.url still contains "adzuna.com" or fetch throws — fall back to [https://www.{company}.com](https://www.{company}.com) (company name from DB)
